...
class EPEqualizerConfigurationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "EQ"
            ...
            for bandSlider in self.verticalBandSliders {
                bandSlider.addTarget(self, action: #selector(EPEqualizerConfigurationViewController.bandSliderValueChanged(_:)), for: UIControl.Event.editingDidEnd)
            }
    ...
    @objc func bandSliderValueChanged(_ bandSlider: EPVerticalBandSlider) {
        ...
        case 0:
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(bandSlider.currentValue), forEqualizerBand: 0)
            break
        case 1:
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(bandSlider.currentValue), forEqualizerBand: 1)
            break
        case 2:
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(bandSlider.currentValue), forEqualizerBand: 2)
            break
        case 3:
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(bandSlider.currentValue), forEqualizerBand: 3)
            break
        case 4:
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(bandSlider.currentValue), forEqualizerBand: 4)
            break
        case 5:
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(bandSlider.currentValue), forEqualizerBand: 5)
            break
        case 6:
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(bandSlider.currentValue), forEqualizerBand: 6)
            break
        case 7:
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(bandSlider.currentValue), forEqualizerBand: 7)
    ...
    @IBAction func presetButtonTap(_ sender: AnyObject) {
        if true {//default
            ...
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(EQGains[0]), forEqualizerBand: 0)
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(EQGains[1]), forEqualizerBand: 1)
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(EQGains[2]), forEqualizerBand: 2)
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(EQGains[3]), forEqualizerBand: 3)
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(EQGains[4]), forEqualizerBand: 4)
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(EQGains[5]), forEqualizerBand: 5)
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(EQGains[6]), forEqualizerBand: 6)
            AudioPlayer.sharedAudioPlayer._stk_audioPlayer.setGain(Float(EQGains[7]), forEqualizerBand: 7)
